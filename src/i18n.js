...
export const STR = {
  zh: {
    ...
    // 首页
    h1: '免费送 Token 合集',
    bannerKicker: '免费额度目录 · 人工核对',
    lede: '收录正在发放免费 AI Token、API 额度与算力的活动。领取链接均指向官方页面，人工核对、持续更新。',
    bannerStats: (s) => `已收录 ${s.total} 个条目 · ${s.categories} 个分类 · ${s.featured} 个精选`,
    modelWallLabel: '覆盖主流大模型',
    free: '免费',
    expired: '已截止',
    expiresIn: (n) => `${n} 天后截止`,
    carouselKicker: '免费 AI Token 聚合平台 · 人工核对持续更新',
    carouselTaglines: [
      'GPT 系列模型免费 API 额度',
      'Claude 模型限时免费体验',
      'Google AI Studio 免费 Gemini 调用',
      'DeepSeek 官方平台新用户送 Tokens',
      '阿里云百炼通义千问免费额度',
      'Moonshot 开放平台 Kimi 免费调用',
      'xAI Grok 免费体验',
      '智谱 AI 新用户送 Tokens · GLM Flash 长期免费',
      'MiniMax 多模态模型免费额度',
      '腾讯混元大模型免费 API 额度',
      '小米 MiMo 开源模型免费体验',
    ],
    slideStats: (n) => (n > 0 ? `站内已收录 ${n} 条相关福利 · 人工核对` : '站内持续收录中 · 人工核对'),
    browseAll: '浏览全部条目',
    aboutLink: '关于本站',
    sidebarHot: '热门精选',
    sidebarLatest: '最新收录',
  ...
  en: {
    ...
    bannerKicker: 'CURATED · FREE AI TOKENS',
    ...
    modelWallLabel: 'Covering mainstream LLMs',
    free: 'Free',
    expired: 'Ended',
    expiresIn: (n) => `${n}d left`,
    carouselKicker: 'FREE AI TOKEN DIRECTORY · CURATED & UPDATED',
    carouselTaglines: [
      'Free API credits for GPT models',
      'Claude — limited-time free trial',
      'Gemini free tier via Google AI Studio',
      'DeepSeek — welcome tokens on signup',
      'Qwen — free credits on Alibaba Cloud',
      'Kimi — free API on Moonshot platform',
      'Grok by xAI — free access',
      'GLM — welcome tokens & always-free Flash',
      'MiniMax — multimodal free credits',
      'Tencent Hunyuan — free API credits',
      'Xiaomi MiMo — free open model access',
    ],
    slideStats: (n) => (n > 0 ? `${n} related offer${n === 1 ? '' : 's'} curated · hand-verified` : 'more offers being curated · hand-verified'),
